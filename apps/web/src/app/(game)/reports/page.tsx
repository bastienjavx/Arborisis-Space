                  ...
                  <div className="border-b border-canopy-700/15 px-6 py-5">
                    <div className="flex flex-wrap items-start justify-between gap-4">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <h2 className="font-display text-2xl text-canopy-50/90">
                            {EXPEDITION_TITLES[selectedReport.outcome]}
                          </h2>
                      ...
                      <div className="flex items-center gap-3">
                        {(() => {
                          const status = expeditionStatus(selectedReport.outcome);
                          const StatusIcon = status.icon;
                          return (
                ...
                {pvpReports.map((report, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="text-xs text-canopy-100/55">
                ...
                {pveReports.map((report, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="min-w-0">
                        <span className="block text-sm text-canopy-100/78">
                          {ENCOUNTER_NAMES[report.encounter.type as NpcEncounterType] ??
