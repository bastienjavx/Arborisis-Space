...
export const BUILDINGS: Record<BuildingType, BuildingConfig> = {
  ...
  [BuildingType.RESEARCH_NEXUS]: {
    ...
    baseCost: { [ResourceType.BIOMASS]: 200, [ResourceType.MINERALS]: 100, [ResourceType.SAP]: 100 },
    costFactor: 1.7,
    maxLevel: 30,
  },
...
export const RESEARCHES: Record<ResearchType, ResearchConfig> = {
  ...
  [ResearchType.BIOENGINEERING]: {
    ...
    baseCost: { [ResourceType.SPORES]: 150, [ResourceType.BIOMASS]: 400, [ResourceType.MINERALS]: 200 },
    costFactor: 1.7,
    maxLevel: 12,
    baseTimeSeconds: 480,
    timeFactor: 1.6,
  ...
  [ResearchType.SPORAL_PROPULSION]: {
    ...
    baseCost: { [ResourceType.SPORES]: 800, [ResourceType.SAP]: 1_000, [ResourceType.MINERALS]: 500 },
    costFactor: 2,
    maxLevel: 10,
